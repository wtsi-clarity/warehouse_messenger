package warehouse_messenger::dao::study_user_dao;
...
warehouse_messenger::dao::study_user_dao

=head1 SYNOPSIS
  my $study_user_dao = warehouse_messenger::dao::study_user_dao->new(lims_id => "1234");
