package warehouse_messenger::dao::containertypes_dao;
...
warehouse_messenger::dao::containertypes_dao

=head1 SYNOPSIS
  my $containertypes_dao = warehouse_messenger::dao::containertypes_dao->new(lims_id => "1234");
