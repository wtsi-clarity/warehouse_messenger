...
{
  my $lims_id = '1234';
  my $study_user_dao = warehouse_messenger::study_user_dao->new( lims_id => $lims_id);
  isa_ok($study_user_dao, 'warehouse_messenger::study_user_dao');
}
...

{
  ...
  lives_ok { warehouse_messenger::study_user_dao->thaw($study_user_json) }
